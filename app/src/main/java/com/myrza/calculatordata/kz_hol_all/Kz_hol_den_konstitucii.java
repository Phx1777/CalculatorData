...
public class Kz_hol_den_konstitucii extends AppCompatActivity implements View.OnClickListener {
    ...
    public String doDenKonstituc = null;
    public String ifNowDenKonstituc = null;
    ...
    class MyTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            doDenKonstituc = getResources().getString(R.string.do_den_konstitucii);
            ifNowDenKonstituc = getResources().getString(R.string.ifNowDenKonstitucii);
            ...
            showResult = Kazakhstan.den_konstitucii(sec, min, hour, day, week, month, year,
                    doDenKonstituc, ifNowDenKonstituc,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kz_hol_den_konstitucii);

        getSupportActionBar().setTitle(getResources().getString(R.string.den_konstitucii));

        Button get_info_about_den_konstitucii = findViewById(R.id.b_get_info_about_den_konstitucii);

        textView = findViewById(R.id.info_result_date);

        View.OnClickListener onClickListener = view -> new MyTask().execute(showResult);

        get_info_about_den_konstitucii.setOnClickListener(onClickListener);

        if (Kazakhstan_activity.bol_to_activate_den_konstitucii) {
            get_info_about_den_konstitucii.callOnClick();
        }

        get_info_about_den_konstitucii.setOnTouchListener(new View.OnTouchListener() {
            @Override
