...
public class Kz_hol_march8 extends AppCompatActivity implements View.OnClickListener {
    ...
    public String doMarch8ostalos = null;
    ...
    class MyTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            ifNow = getResources().getString(R.string.ifNow8March);
            doMarch8ostalos = getResources().getString(R.string.do_march8_ostalos);
            ...
            showResult = Kazakhstan.march8(sec, min, hour, day, week, month, year,
                    doMarch8ostalos, ifNow, monday, tuesday, wednesday, thursday, friday,
                    saturday, sunday);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kz_hol_march8);

        getSupportActionBar().setTitle(getResources().getString(R.string.b_march8));

        Button get_info_about_march8 = findViewById(R.id.b_get_info_about_march8);
        ...
        get_info_about_march8.setOnClickListener(onClickListener);

        if (Kazakhstan_activity.bol_to_activate_march8) {
            get_info_about_march8.callOnClick();
        }

        get_info_about_march8.setOnTouchListener(new View.OnTouchListener() {
            @Override
