...
public class Kz_hol_den_pobedy extends AppCompatActivity implements View.OnClickListener {
    ...
    public String doDenPobedy = null;
    public String ifNowDenPobedy = null;
    ...
    class MyTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            doDenPobedy = getResources().getString(R.string.do_den_pobedy_ostalos);
            ifNowDenPobedy = getResources().getString(R.string.ifNowDenPobedy);
            ...
            showResult = Kazakhstan.den_pobedy(sec, min, hour, day, week, month, year,
                    doDenPobedy, ifNowDenPobedy, monday, tuesday, wednesday, thursday, friday,
                    saturday, sunday);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kz_hol_den_pobedy);

        getSupportActionBar().setTitle(getResources().getString(R.string.b_den_pobedy));

        Button get_info_about_den_pobedy = findViewById(R.id.b_get_info_about_den_pobedy);
        ...
        get_info_about_den_pobedy.setOnClickListener(onClickListener);

        if (Kazakhstan_activity.bol_to_activate_den_pobedy) {
            get_info_about_den_pobedy.callOnClick();
        }

        get_info_about_den_pobedy.setOnTouchListener(new View.OnTouchListener() {
            @Override
