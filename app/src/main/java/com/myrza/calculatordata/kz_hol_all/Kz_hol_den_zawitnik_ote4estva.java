...
public class Kz_hol_den_zawitnik_ote4estva extends AppCompatActivity implements View.OnClickListener {
    ...
    public String doDenZawitOt = null;
    public String ifNowDenZawitOt = null;
    ...
    class MyTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            doDenZawitOt = getResources().getString(R.string.do_den_zawitnika_ot);
            ifNowDenZawitOt = getResources().getString(R.string.ifNowDenZawitnikaOt);
            ...
            showResult = Kazakhstan.den_zawitnika_ote4estva(sec, min, hour, day, week, month, year,
                    doDenZawitOt, ifNowDenZawitOt, monday, tuesday, wednesday, thursday, friday,
                    saturday, sunday);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kz_hol_den_zawitnik_ote4estva);

        getSupportActionBar().setTitle(getResources().getString(R.string.b_den_zawitnika_ote4estva));

        Button get_info_about_den_zawit_ote4 = findViewById(R.id.b_get_info_about_zawitnik_ote4estva);
        ...
        get_info_about_den_zawit_ote4.setOnClickListener(onClickListener);

        if (Kazakhstan_activity.bol_to_activate_den_zawit_ote4) {
            get_info_about_den_zawit_ote4.callOnClick();
        }

        get_info_about_den_zawit_ote4.setOnTouchListener(new View.OnTouchListener() {
            @Override
