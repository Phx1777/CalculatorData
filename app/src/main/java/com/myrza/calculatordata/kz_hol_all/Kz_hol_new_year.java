...
public class Kz_hol_new_year extends AppCompatActivity implements View.OnClickListener {
    ...
    public String doNovogoGodaOstalos = null;
    public String ifNowNG = null;
    ...
    class MyTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            doNovogoGodaOstalos = getResources().getString(R.string.do_ng_ostalos);
            ifNowNG = getResources().getString(R.string.ifNowNG);
            ...
            showResult = Kazakhstan.new_year(sec, min, hour, day, week, month, year,
                    doNovogoGodaOstalos, ifNowNG, monday, tuesday, wednesday, thursday, friday,
                    saturday, sunday);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kz_hol_new_year);

        Objects.requireNonNull(getSupportActionBar()).setTitle(getResources().getString(R.string.b_new_year));
        ...
        get_info_about_new_year.setOnClickListener(onClickListener);

        if (Kazakhstan_activity.bol_to_activate_new_year) {
            get_info_about_new_year.callOnClick();
        }

        get_info_about_new_year.setOnTouchListener(new View.OnTouchListener() {
            @Override
