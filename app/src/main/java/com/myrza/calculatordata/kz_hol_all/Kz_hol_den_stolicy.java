...
public class Kz_hol_den_stolicy extends AppCompatActivity implements View.OnClickListener {
    ...
    public String do_den_stolic = null;
    public String ifNowDenStolicy = null;
    ...
    class MyTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            do_den_stolic = getResources().getString(R.string.do_den_stolicy);
            ifNowDenStolicy = getResources().getString(R.string.ifNowDenStolicy);
            ...
            showResult = Kazakhstan.den_stolicy(sec, min, hour, day, week, month, year,
                    do_den_stolic, ifNowDenStolicy, monday, tuesday, wednesday, thursday, friday,
                    saturday, sunday);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kz_hol_den_stolicy);

        getSupportActionBar().setTitle(getResources().getString(R.string.den_stolicy));
        ...
        get_info_about_den_stolicy.setOnClickListener(onClickListener);

        if (Kazakhstan_activity.bol_to_activate_den_stolicy) {
            get_info_about_den_stolicy.callOnClick();
        }

        get_info_about_den_stolicy.setOnTouchListener(new View.OnTouchListener() {
            @Override
