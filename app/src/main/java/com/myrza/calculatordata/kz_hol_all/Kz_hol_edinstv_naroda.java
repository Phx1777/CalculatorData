...
public class Kz_hol_edinstv_naroda extends AppCompatActivity implements View.OnClickListener {
    ...
    public String doDenEdinstvNarodaOst = null;
    public String ifNowDenEdinstvNaroda = null;
    ...
    class MyTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            doDenEdinstvNarodaOst = getResources().getString(R.string.do_den_edinst_naroda);
            ifNowDenEdinstvNaroda = getResources().getString(R.string.ifNowDenEdinstvNar);
            ...
            showResult = Kazakhstan.edinstvo_naroda_kz(sec, min, hour, day, week, month, year,
                    doDenEdinstvNarodaOst, ifNowDenEdinstvNaroda, monday, tuesday, wednesday, thursday, friday,
                    saturday, sunday);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kz_hol_edinstv_naroda);

        getSupportActionBar().setTitle(getResources().getString(R.string.edinstvo_naroda_kz));
        ...
        get_info_about_den_edinstva_naroda.setOnClickListener(onClickListener);

        if (Kazakhstan_activity.bol_to_activate_edinstv_naroda_kz) {
            get_info_about_den_edinstva_naroda.callOnClick();
        }

        get_info_about_den_edinstva_naroda.setOnTouchListener(new View.OnTouchListener() {
            @Override
