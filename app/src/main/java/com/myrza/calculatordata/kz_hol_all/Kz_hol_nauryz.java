...
public class Kz_hol_nauryz extends AppCompatActivity implements View.OnClickListener {
    ...
    public String doNauryzOstalos = null;
    public String ifNowNauryz = null;
    ...
    class MyTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            doNauryzOstalos = getResources().getString(R.string.do_nauryz_ostalos);
            ifNowNauryz = getResources().getString(R.string.ifNowNauryz);
            ...
            showResult = Kazakhstan.nauryz(sec, min, hour, day, week, month, year,
                    doNauryzOstalos, ifNowNauryz, monday, tuesday, wednesday, thursday, friday,
                    saturday, sunday);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kz_hol_nauryz);

        getSupportActionBar().setTitle(getResources().getString(R.string.b_nauryz));
        ...
        get_info_about_nauryz.setOnClickListener(onClickListener);

        if (Kazakhstan_activity.bol_to_activate_nauryz) {
            get_info_about_nauryz.callOnClick();
        }

        get_info_about_nauryz.setOnTouchListener(new View.OnTouchListener() {
            @Override
