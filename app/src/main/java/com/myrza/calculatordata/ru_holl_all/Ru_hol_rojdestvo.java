...
public class Ru_hol_rojdestvo extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ru_hol_rojdestvo);

        getSupportActionBar().setTitle(getResources().getString(R.string.b_rojdestvo));

        Button get_info_about_rojdestvo = findViewById(R.id.b_get_info_about_rojdestvo_ru);
        ...
        if (Russia_activity.bol_to_activate_rojdestvo) {
