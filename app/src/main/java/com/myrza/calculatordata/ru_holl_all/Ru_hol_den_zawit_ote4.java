...
public class Ru_hol_den_zawit_ote4 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ru_hol_den_zawit_ote4);
        ...
        if (Russia_activity.bol_to_activate_den_zawit_ote4){
