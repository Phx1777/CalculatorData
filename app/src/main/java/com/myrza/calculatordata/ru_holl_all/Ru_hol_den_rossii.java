...
public class Ru_hol_den_rossii extends AppCompatActivity implements View.OnClickListener {
    ...
    public String doDenRossii = null;
    ...
    class MyTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            ifNow = getResources().getString(R.string.res_if_now_den_rossii);
            doDenRossii = getResources().getString(R.string.res_do_den_rossii);
            ...
            showResult = Russia.den_rossii(sec, min, hour, day, week, month, year, doDenRossii, ifNow
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ru_hol_den_rossii);

        getSupportActionBar().setTitle(getResources().getString(R.string.b_den_rossii));
        ...
        b_den_rossii_ru.setOnClickListener(onClickListener);

        if (Russia_activity.bol_to_activate_den_rosii){
            b_den_rossii_ru.callOnClick();
        }

        b_den_rossii_ru.setOnTouchListener(new View.OnTouchListener() {
            @Override
