...
public class Ru_hol_den_pobedy extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ru_hol_den_pobedy);

        getSupportActionBar().setTitle(getResources().getString(R.string.b_den_pobedy));

        Button get_info_about_den_pobedy = findViewById(R.id.b_get_info_about_den_pobedy_ru);
        ...
        if (Russia_activity.bol_to_activate_den_pobedy){
