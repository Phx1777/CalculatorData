...
public class Ru_hol_pasha extends AppCompatActivity implements View.OnClickListener {
    ...
    class MyTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            ifNow = getResources().getString(R.string.res_if_now_pasha);
            doPashiOst = getResources().getString(R.string.res_do_pashi_ost);
            ...
            showResult = Russia.pasha(sec, min, hour, day, week, month, year, doPashiOst, ifNow
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ru_hol_pasha);

        getSupportActionBar().setTitle(getResources().getString(R.string.b_pasha));
        ...
        b_pasha.setOnClickListener(onClickListener);

        if (Russia_activity.bol_to_activate_pasha) {
            b_pasha.callOnClick();
        }

        b_pasha.setOnTouchListener(new View.OnTouchListener() {
            @Override
