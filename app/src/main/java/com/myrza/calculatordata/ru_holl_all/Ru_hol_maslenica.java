...
public class Ru_hol_maslenica extends AppCompatActivity implements View.OnClickListener {
    ...
    public String doMaslenicy = null;
    ...
    class MyTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            ifNow = getResources().getString(R.string.res_if_now_maslenica);
            doMaslenicy = getResources().getString(R.string.res_do_maslenicy);
            ...
            showResult = Russia.maslenica(sec, min, hour, day, week, month, year, doMaslenicy, ifNow
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ru_hol_maslenica);

        getSupportActionBar().setTitle(getResources().getString(R.string.b_maslenica));
        ...
        b_maslenica.setOnClickListener(onClickListener);

        if (Russia_activity.bol_to_activate_maslenica){
            b_maslenica.callOnClick();
        }

        b_maslenica.setOnTouchListener(new View.OnTouchListener() {
            @Override
