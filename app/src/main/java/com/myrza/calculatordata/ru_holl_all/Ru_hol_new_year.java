...
public class Ru_hol_new_year extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ru_hol_new_year);

        getSupportActionBar().setTitle(getResources().getString(R.string.b_new_year));
        ...
        if (Russia_activity.bol_to_activate_new_year) {
